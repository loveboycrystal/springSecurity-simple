...
-- Records of menu
-- ----------------------------
INSERT INTO `menu` VALUES (1, '', 'Spring Security', 'index', '/index', 1, 0, 1, '2019-10-02 19:57:40', '2019-10-02 19:57:41', 1, 0);
INSERT INTO `menu` VALUES (3, '', '会员列表', 'user_list', '/user/list', 2, 1, 1, '2019-10-23 15:40:27', '2019-10-23 15:40:27', 1, 0);
INSERT INTO `menu` VALUES (4, '', '角色列表', 'role_list', '/role/list', 2, 1, 2, '2019-10-23 15:44:02', '2019-10-23 15:44:02', 1, 0);
INSERT INTO `menu` VALUES (5, '', '菜单列表', 'menu_list', '/menu/list', 2, 1, 3, '2019-10-23 15:45:30', '2019-10-23 15:45:30', 1, 0);
INSERT INTO `menu` VALUES (6, '', '添加用户', 'user_add', '/user/add', 3, 3, 1, '2019-10-28 11:38:26', '2019-10-28 11:38:26', 1, 0);
INSERT INTO `menu` VALUES (7, '', '修改用户', 'user_edit', '/user/update', 3, 3, 2, '2019-10-28 11:39:06', '2019-10-28 11:39:06', 1, 0);
INSERT INTO `menu` VALUES (10, '', '删除用户', 'user_del', '/user/del', 3, 3, 5, '2019-10-28 11:41:24', '2019-10-28 11:41:24', 1, 0);
...
-- Records of role
-- ----------------------------
INSERT INTO `role` VALUES (1, 'super_admin', '超级管理员', '2019-10-02 12:10:07', '2019-10-02 12:10:08', 1, 0);
...
CREATE TABLE `role_resource`  (
  ...
  `resource_id` bigint(20) NULL DEFAULT 0 COMMENT '资源ID',
  `resource_type` tinyint (20) NULL DEFAULT 0 COMMENT '资源类型， 0 菜单，1 页面元素id，2 接口URL',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `role_resource` VALUES (1, 1, 1,0);
INSERT INTO `role_resource` VALUES (2, 1, 10,0);
INSERT INTO `role_resource` VALUES (3, 1, 3,0);
INSERT INTO `role_resource` VALUES (4, 1, 4,0);
INSERT INTO `role_resource` VALUES (5, 1, 5,0);
INSERT INTO `role_resource` VALUES (6, 1, 6,0);
INSERT INTO `role_resource` VALUES (7, 1, 7,0);
INSERT INTO `role_resource` VALUES (8, 2, 1,0);
INSERT INTO `role_resource` VALUES (9, 2, 3,0);
INSERT INTO `role_resource` VALUES (10, 2, 4,0);
INSERT INTO `role_resource` VALUES (11, 2, 5,0);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, '帅帅', 'admin', 'admin', 2, '2019-10-23 16:18:38', '2019-10-28 16:02:55', 1, 0);
...
-- ----------------------------
INSERT INTO `user_role` VALUES (1, 1, 1, '2019-10-02 12:10:19', '2019-10-25 17:11:15', 1, 0);
